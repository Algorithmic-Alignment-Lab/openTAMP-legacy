...
Try running `python opentamp/src/test_grip_osqp.py` from the root of the repository, and if this script successfully completes and displays a short video at the end, your installation is correct!
