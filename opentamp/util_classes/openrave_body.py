...
from opentamp.util_classes.errors_exceptions import OpenRAVEException
...
from opentamp.robot_info.robots import Robot, Baxter
from opentamp.util_classes.items import Item, Box, Can, BlueCan, RedCan, Circle, BlueCircle, RedCircle, GreenCircle, Obstacle, Wall, Table, Basket
...
class OpenRAVEBody(object):
    ...
    def param_fwd_kinematics(self, param, manip_names, t, mat_result=False):
        ...
        for manip_name in manip_names:
            result[manip_name] = self.fwd_kinematics(manip_name, mat_result=True)
