...
def get_vector(config):
    ...
    state_vector_include['milk'] = ['pose', 'rotation']
    state_vector_include['can'] = ['pose', 'rotation']
    state_vector_include['bread'] = ['pose', 'rotation']
    ...
    target_vector_include = {
        ...
        'milk_end_target': ['value', 'rotation'],
        'can_end_target': ['value', 'rotation'],
        'bread_end_target': ['value', 'rotation'],
    }
