...
domain_file = "../domains/namo_domain/namo_current_arm.domain"
mapping_file = "policy_hooks/namo/arm_task_mapping"
pddl_file = "../domains/namo_domain/arm_domain.pddl"
...
def prob_file(descr=None):
    if descr is None:
        descr = 'arm_prob_{0}_{1}end_{2}aux'.format(NUM_OBJS, len(END_TARGETS), n_aux)
...
def get_vector(config):
    state_vector_include = {
        'pr2': ['joint1', 'joint2', 'wrist', 'gripper']
    }
